...
class ExcelUtilTest extends BaseClass {
    ...
    public static Logger logger = LoggerFactory.getLogger(ExcelUtilTest.class);
    static String token;
    ...
    void generateExcel() throws IOException {
        ByteArrayInputStream export = excelUtil.createAndExport(List.of(new com.jyalla.demo.modal.User(UUID.fromString("db47ce58-6f03-4d6d-9902-3837c925406d"), "dummyUser",
                "dummy@email.com", "1234", "", true, "Admin", new Date(), "$2a$04$8T6i2fjNU54gI8LgArCLEOP8XMMSw/.bq/iRhuL6Y.ha46NyKAMaq", 2)));
